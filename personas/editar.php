...
if (!$persona) {
    setMensaje('Persona no encontrada.', 'danger');
    header('Location: index.php');
    exit;
}
...
$municipios = $persona['id_departamento'] ? obtenerMunicipiosPorDepartamento($persona['id_departamento']) : [];
?>

<h2><i class="fas fa-user-edit"></i> Editar Persona</h2>
        ...
        <form action="guardar.php" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="id_tipo_identificacion" name="id_tipo_identificacion" required>
                        ...
                        <?php foreach ($tiposIdentificacion as $ti): ?>
                            <option value="<?php echo $ti['id_tipo_identificacion']; ?>" <?php echo $ti['id_tipo_identificacion'] == $persona['id_tipo_identificacion'] ? 'selected' : ''; ?>>
                                <?php echo h($ti['nombre']); ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="numero_identificacion" name="numero_identificacion" value="<?php echo h($persona['numero_identificacion']); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="nombre" class="form-label">Nombre Completo *</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo h($persona['nombre']); ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="id_pais" name="id_pais" required>
                        ...
                        <?php foreach ($paises as $pais): ?>
                            <option value="<?php echo $pais['id_pais']; ?>" <?php echo $pais['id_pais'] == $persona['id_pais'] ? 'selected' : ''; ?>>
                ...
                <div class="col-md-6 mb-3" id="departamento_group">
                    ...
                    <select class="form-select" id="id_departamento" name="id_departamento">
                        ...
                        <?php foreach ($departamentos as $dep): ?>
                            <option value="<?php echo $dep['id_departamento']; ?>" <?php echo $dep['id_departamento'] == $persona['id_departamento'] ? 'selected' : ''; ?>>
                ...
                <div class="col-md-6 mb-3" id="municipio_group">
                    ...
                    <select class="form-select" id="id_municipio" name="id_municipio">
                        ...
                        <?php foreach ($municipios as $mun): ?>
                            <option value="<?php echo $mun['id_municipio']; ?>" <?php echo $mun['id_municipio'] == $persona['id_municipio'] ? 'selected' : ''; ?>>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="direccion" name="direccion" value="<?php echo h($persona['direccion'] ?? ''); ?>" placeholder="Dirección exacta (opcional)">
                </div>
                <div class="col-md-6 mb-3">
                    <label for="telefono" class="form-label">Teléfono</label>
                    <input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo h($persona['telefono']); ?>">
                </div>
                <div class="col-md-6 mb-3">
                    <label for="correo" class="form-label">Correo Electrónico</label>
                    <input type="email" class="form-control" id="correo" name="correo" value="<?php echo h($persona['correo']); ?>">
                </div>
            </div>
    ...
    if (idDepartamento) {
        fetch('<?php echo BASE_URL; ?>ajax_municipios.php?departamento=' + idDepartamento)
            ...
            .then(data => {
                ...
                const currentMunicipio = <?php echo json_encode($persona['id_municipio']); ?>;
                if (currentMunicipio) {
...
document.addEventListener('DOMContentLoaded', function() {
    toggleDepartamentoMunicipio();
    if (parseInt(paisSelect.value) === idNicaragua && departamentoSelect.value) {
        cargarMunicipios(departamentoSelect.value);
    }
});
</script>
