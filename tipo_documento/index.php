...
$resultado = buscarTiposDocumentos($busqueda, $pagina, $limite);
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo BASE_URL; ?>tipo_documento/crear.php" class="btn btn-primary"><i class="fas fa-plus"></i> Nuevo Tipo</a>
</div>
                    ...
                    <?php if (count($datos) > 0): ?>
                        <?php foreach ($datos as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo BASE_URL; ?>tipo_documento/editar.php?id_tdoc=<?php echo $item['id_tipo_documento']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                    <a href="<?php echo BASE_URL; ?>tipo_documento/eliminar.php?id_tdoc=<?php echo $item['id_tipo_documento']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar este tipo?')"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="3" class="text-center">No hay tipos de documento que coincidan con la búsqueda.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
